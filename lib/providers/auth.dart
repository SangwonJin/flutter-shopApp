...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDXzd4LksML0S4HU5qqRiIgsnjHx5LWJVg';
    try {
      ...
      _expiryDate = DateTime.now().add(
        Duration(seconds: int.parse(responsedData['expiresIn'])),
      );
